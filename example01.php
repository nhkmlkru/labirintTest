...
// пробуем изменить четыре свойства, "albumCollection" и "meta" readonly, свойства "zero" не существует
$testPropertis = array("albumCollection" => 2, "size" => 2, "meta" => array("someValue"), "zero" => 1);
